...
class IncomeGroupsAdapter(
    private val onIncomeClick: (IncomeGroupRemaining) -> Unit,
    currencySymbol: String
) :
    ListAdapter<IncomeGroupRemaining, IncomeGroupsAdapter.IncomesViewHolder>(IncomeDiffCallback()) {
    ...
    override fun onBindViewHolder(holder: IncomeGroupsAdapter.IncomesViewHolder, position: Int) {
